        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 py-12 lg:py-24">
          <div className="space-y-12">
            <FadeIn>
              ...
              <p className="text-xl text-mckinsey-gray-600 font-light leading-relaxed max-w-lg">{c.desc}</p>
            </FadeIn>
            ...
            <FadeIn delay={200}>
              <div className="space-y-8">
                <div className="group flex items-start gap-6 p-6 bg-white rounded-2xl border border-gray-100 hover:border-mckinsey-teal-200 hover:shadow-lg transition-all duration-300">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-mckinsey-navy-900 mb-1">{c.email_label}</h3>
                    <a href="mailto:contact@example.com" className="text-mckinsey-gray-600 hover:text-mckinsey-teal-600 transition-colors text-lg">contact@example.com</a>
                  </div>
                </div>
                <div className="group flex items-start gap-6 p-6 bg-white rounded-2xl border border-gray-100 hover:border-mckinsey-teal-200 hover:shadow-lg transition-all duration-300">
                  <div className="p-4 bg-mckinsey-gray-50 rounded-xl group-hover:bg-mckinsey-teal-50 transition-colors">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-mckinsey-navy-900 mb-1">{c.location_label}</h3>
                    <p className="text-mckinsey-gray-600 text-lg">{c.location_value}</p>
                  </div>
                </div>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={400}>
              <div className="pt-8 border-t border-gray-100">
                <h3 className="text-sm font-medium text-mckinsey-gray-500 uppercase tracking-wider mb-6">{c.social_title}</h3>
                <div className="flex gap-4">
                  <a href="#" className="p-3 bg-mckinsey-gray-50 rounded-full hover:bg-mckinsey-navy-900 hover:text-white transition-all duration-300"><Linkedin className="w-5 h-5" /></a>
                  <a href="#" className="p-3 bg-mckinsey-gray-50 rounded-full hover:bg-mckinsey-navy-900 hover:text-white transition-all duration-300"><Github className="w-5 h-5" /></a>
                </div>
              </div>
            </FadeIn>
          </div>
