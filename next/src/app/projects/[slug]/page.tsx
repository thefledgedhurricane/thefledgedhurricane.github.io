...
export async function generateMetadata({ params }: ProjectPageProps): Promise<Metadata> {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/projects/${project.slug.current}`;
  const ogImage = project.featuredImage?.asset
...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  const breadcrumbJsonLd = generateBreadcrumbJsonLd([
    ...
    { name: 'Projects', url: `${process.env.NEXT_PUBLIC_SITE_URL}/projects` },
    { name: project.title, url: `${process.env.NEXT_PUBLIC_SITE_URL}/projects/${project.slug.current}` },
  ]);
      ...
      <div className="bg-white dark:bg-gray-900 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-8">
            <Link 
              href="/projects" 
              className="inline-flex items-center text-blue-600 hover:text-blue-700 dark:hover:text-blue-400 mb-4"
            >
          ...
          {/* Project Image */}
          <div className="aspect-video bg-gray-200 dark:bg-gray-800 rounded-xl overflow-hidden mb-8">
            <Image
              src={imageUrl}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            {/* Links */}
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">Liens</h3>
              <div className="space-y-2">
                ...
                {project.githubUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100"
                  >
            ...
            {/* Date */}
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">Publié</h3>
